...
func BFSGrid[T comparable](matrix [][]T, startX, startY int, shouldTravel ShouldTravelFunc, handleVisitFunc HandleVisitFunc, handleTravelBlockedFunc HandleTravelBlockedFunc) {
	rows := len(matrix)
	cols := len(matrix[0])
